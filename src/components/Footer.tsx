...
export const Footer = ({}) => {
  ...
  return (
    <div className={'flex flex-row justify-center gap-1 break-all border-2 border-black p-2 text-sm'}>
      {nodeConnectionData}
      <a target="_blank" href={'https://twitter.com/SchlausKwab'} rel="noreferrer">
      ...
      <a target="_blank" href={'https://github.com/zerealschlauskwab/lnapp-starter'} rel="noreferrer">
        <svg className={'h-4 w-4'} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      ...
      <a target="_blank" href={'https://t.me/zeRealSchlausKwab'} rel="noreferrer">
