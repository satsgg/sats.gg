                  ...
                  >
                    ...
                    <li>
                      <Link href={`/${user.userName}`}>
                        <a className="inline-flex w-full whitespace-nowrap rounded bg-transparent py-1 px-1 text-sm font-normal text-white hover:bg-stone-700">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                    ...
                    <li>
                      <Link href="/wallet">
                        <a className="dropdown-item inline-flex w-full items-center whitespace-nowrap rounded bg-transparent py-1 px-1 text-sm font-normal text-white hover:bg-stone-700">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="mr-1 h-5 w-5"
                            fill="none"
