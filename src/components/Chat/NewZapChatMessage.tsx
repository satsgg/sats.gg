...
const ZapChatMessage = ({
  ...
  return (
    <div className="relative mx-2 my-2">
      <div className="absolute -inset-[4px] rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 opacity-50 blur-[4px]"></div>
      <div className="absolute -inset-[2px] rounded-lg bg-gradient-to-r from-purple-400 to-pink-400 opacity-50 blur-[1px]"></div>
      <div className="absolute -inset-[2px] rounded-lg bg-gradient-to-r from-purple-400 to-pink-400 opacity-75"></div>
      <div className="relative flex items-start rounded-lg bg-background/95 px-2 py-2 backdrop-blur-[2px]">
